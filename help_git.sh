...
echo ""
echo -e "${BLUE}git ${CYAN}checkout ${GREEN}[--theirs/--ours] path/to/file ${NO_COLOR}- during merge conflict checkout changes using ${GREEN}--theirs${NO_COLOR} or ${GREEN}--ours${NO_COLOR} flag"
echo -e "${GREEN}--ours${NO_COLOR} will overwrite the file with the changes from the branch you are currently on and merging into"
echo -e "${GREEN}--theirs${NO_COLOR} will overwrite the file with the changes from the branch you are merging into the current branch"
echo ""
echo -e "${BLUE}git ${CYAN}reset ${GREEN}--soft commithash ${NO_COLOR}- undo commit/staged changes/unstage changes to commithash. Flag --soft undo to prev commit but keep all of the changes."
echo -e "${BLUE}git ${CYAN}reset ${GREEN}--soft HEAD~1 ${NO_COLOR}- undo last commit/staged changes/unstage changes. Flag --soft undo to prev commit but keep all of the changes."
...
echo ""
echo ""
echo -e "${RED}ADVANCE${NO_COLOR} GIT COMMANDS IN CLI\n"
...
echo -e "${BLUE}git ${CYAN}reflog ${NO_COLOR}- show where HEAD was X move ago (steps history)"
echo -e "${BLUE}git ${CYAN}merge ${GREEN}HEAD@{n} ${NO_COLOR}- merges changes from step in history"
echo -e "${BLUE}git ${CYAN}merge ${GREEN}<commitish> ${NO_COLOR} - git merge take commitish which mean you can merge from branch/tag/commit/HEAD@{1}"
echo ""